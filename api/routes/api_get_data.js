...
router.get('/get-class-work-dates-by-section/:id',get_data_contoller.get_class_work_dates_by_section)
router.get('/get-classwork-by-date-section/:sec_id/:date',get_data_contoller.get_classwork_by_sec_id_by_date)
